...
int main()
    ...
    printf("\n\n\n\n\n\n\t\tResister your Name:");
     gets(playername);
    system("cls");
    printf("\n------------------  Welcome %s to Mind Scribble -----------------------",playername);
	...
	goto mainhome;
     ...
     test:
     system("cls");
     printf("\n\n\t** CONGRATULATION %s you are eligible to play the Next Round!!!**",playername);
...
void help()
	...
	printf("\n\n***************************BEST OF LUCK**********************************");
	printf("\n\n   C Programming Mind Scribble game done by R.R.Srikanth and Surendren ");}
